...
<head>
    <meta charset="UTF-8">
    <title>{{cbLang("page_title_login")}} : TPS</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post" id="login-form">
            ...
            <div class="form-group has-feedback">
                <input id="email" autocomplete='off' type="text" class="form-control" name='email' required placeholder="Email"/>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input id="password" autocomplete='off' type="password" class="form-control" name='password' required placeholder="Password"/>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div style="margin-bottom:10px" class='row'>
                <div class='col-xs-12'>
                    <button type="button" id="login-button" class="btn btn-primary btn-block btn-flat"><i class='fa fa-lock'></i> {{cbLang("button_sign_in")}}</button>
                </div>
            </div>
...
@include('crudbooster::terms-and-conditions')
